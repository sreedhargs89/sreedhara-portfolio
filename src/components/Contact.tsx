...
const Contact = () => {
  ...
  const colorClasses: Record<string, { bg: string; hover: string; text: string }> = {
    blue: { bg: 'bg-blue-100', hover: 'hover:bg-blue-200', text: 'text-blue-600' },
    green: { bg: 'bg-green-100', hover: 'hover:bg-green-200', text: 'text-green-600' },
    indigo: { bg: 'bg-indigo-100', hover: 'hover:bg-indigo-200', text: 'text-indigo-600' },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-blue-200 text-lg max-w-2xl mx-auto">
            I'm always open to discussing new opportunities, innovative projects, or ways to contribute to your team's success.
          </p>
        </div>
          ...
          {contactMethods.map((method, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-blue-200 text-sm break-all">{method.value}</p>
              </a>
            );
          })}
        </div>
        ...
        <div className="text-center mt-12">
          <a
            href={`mailto:${personalInfo.email}`}
            className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
          >
